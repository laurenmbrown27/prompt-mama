[README.md](https://github.com/user-attachments/files/27147087/README.md)
# Prompt Mama
...
├── press-kit.html          # Press & media kit (linked from main page)
├── styles.css              # Shared styles
├── press.css               # Press kit-specific styles
├── script.js               # Scroll reveal + dynamic year
├── press.js                # Bio tab switching + copy-to-clipboard
├── netlify.toml            # Netlify deploy config + cache headers
├── robots.txt              # SEO crawler config
├── sitemap.xml             # Sitemap (lists both pages)
├── .gitignore
├── README.md
└── assets/
    ...
    ├── press-kit-bundle.zip  # Downloadable press bundle
